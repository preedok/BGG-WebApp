          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            ...
            <div className="sm:col-span-2">
              ...
              <div className="relative">
                ...
                <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="No. invoice, order, atau nama owner..." className="w-full pl-9 pr-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500" />
              </div>
            </div>
            <div>
